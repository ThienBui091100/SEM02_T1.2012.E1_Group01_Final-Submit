				...
				<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="image/<?php echo $row_chitiet['sanpham_image'] ?>">
									<div class="thumb-image">
										<img src="image/<?php echo $row_chitiet['sanpham_image'] ?>"  width="200" height="200" data-imagezoom="true" class="img-fluid" alt=""> </div>
								</li>
