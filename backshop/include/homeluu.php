...
<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Categories</h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
										...
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="?quanly=chitietsp&id=<?php echo $row_sanpham['sanpham_id'] ?>" class="link-product-add-cart">Product detail</a>
												</div>
											</div>
										</div>
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							<h3 class="agileits-sear-head mb-3">Search</h3>
							<form action="#" method="post">
								<input type="search" placeholder="Product..." name="search" required="">
						...
						<div class="range border-bottom py-2">
							...
							<div class="w3l-range">
								<ul>
									<li>
										<a href="#">Less than 1,000,000 VND</a>
									</li>
						...
						<div class="customer-rev border-bottom left-side py-2">
							<h3 class="agileits-sear-head mb-3">Review</h3>
							<ul>
								<li>
									<a href="#">
						...
						<div class="f-grid py-2">
							<h3 class="agileits-sear-head mb-3">Best sales</h3>
								...
								<div class="scroll">
									...
									<div class="row">
										<div class="col-lg-3 col-sm-2 col-3 left-mar">
											<img src="image/<?php echo $row_sanpham_sidebar['sanpham_image'] ?>"  width="200" height="200" lt="" class="img-fluid">
										</div>
