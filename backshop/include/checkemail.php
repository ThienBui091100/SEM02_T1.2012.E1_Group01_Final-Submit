<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if (empty($email_err)) {
        $sql = "SELECT email,fullname FROM Userlog WHERE email='$email'";
        ...
        if (mysqli_num_rows($result) <= 0) {
          ...
          $chuoilink='<a href="http://backshop1.ddns.net/backshop/resetpassword.php?email='.$email_encode.'&token='.$m_token.'">Click here to proceed with the password reset.</a>';
          ...
          //#4
          if (!$mail->send()) {
            phpAlertUrl("Email cannot be sent!","login.php");
            //echo "Email cannot be sent!";
          }
          else {
            //echo $message;
            phpAlertUrl("Hi ".$fullname.", we have sent password reset information to your email, please check your email and follow the instructions.!","login.php");
          }
        }
      }
    }
...
<head>
    ...
    <link rel="icon" href="../images/backshop.jpg">
</head>
<style>
    .error {color: #FF0000;}          
</style>
        ...
        <tr align="center">
            <td>
                ...
                <div class="buttons1">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="login.php" class="btn effect01 font1"><span>CANCEL</span></a>
                </div>
                <br>
                <br>
              </td>
