<?php
	...
	if (mysqli_num_rows($sql_category) <= 0) {
		phpAlertUrl("Pants products have not been updated!","../backshop/index.php");
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="image/<?php echo $row_sanpham['sanpham_image'] ?>" width="200" height="200" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="?quanly=chitietsp&id=<?php echo $row_sanpham['sanpham_id'] ?>" class="link-product-add-cart">Product detail
												</a>
												</div>
											</div>
										</div>
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												...
												<fieldset>
													...
													<input type="submit" name="themgiohang" value="Add Cart" class="button" />
												</fieldset>
											</form>
											</div>
										</div>
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							...
							<div class="left-side py-2">
								<ul>
									...
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Reebok</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Lee Jeans</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
									...
									<li>
										<input type="checkbox" class="checked">
										<span class="span">Turnbull & Asser</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
									...
									<li>
										<input type="checkbox" class="checked">
										<span class="span">The Tie Bar</span>
									</li>
									<li>
										<input type="checkbox" class="checked">
						...
						<div class="left-side border-bottom py-2">
							<h3 class="agileits-sear-head mb-3">Size</h3>
							<ul>
								<li>
									<input type="checkbox" class="checked">
						...
						<div class="range border-bottom py-2">
							...
							<div class="w3l-range">
								<ul>
									<li>
										<a href="#">Under 1,000,000 VND</a>
									</li>
									<li class="my-1">
										<a href="#">1,000,000 - 5,000,000 VND</a>
									</li>
									<li>
										<a href="#">5,000,000 - 10,000,000 VND</a>
									</li>
									<li class="my-1">
										<a href="#">10,000,000 - 15,000,000 VND</a>
									</li>
									<li>
										<a href="#">15,000,000 - 20,000,000 VND</a>
									</li>
									<li class="mt-1">
										<a href="#">Over 20,000,000 VND</a>
									</li>
								</ul>
							</div>
						</div>
